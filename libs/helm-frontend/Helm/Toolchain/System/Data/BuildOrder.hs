...
module Helm.Toolchain.System.Data.BuildOrder (
    SerialBuildOrder
  , ParallelBuildOrder
  , ModuleName
  , ModuleImport
...
type SerialBuildOrder  = [(ModuleName, ModuleImports)]
type ParallelBuildOrder = [SerialBuildOrder]


type ModuleName    = ID.Namespace
type ModuleImport  = ID.Namespace
