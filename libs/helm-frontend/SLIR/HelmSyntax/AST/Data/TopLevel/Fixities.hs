...
pattern InfixL :: IR.Sym -> IR.OpPrecedence -> Maybe IR.Meta -> IR.Infix
pattern InfixL sym precedence optMeta = IR.InfixL sym precedence optMeta

pattern InfixR :: IR.Sym -> IR.OpPrecedence -> Maybe IR.Meta -> IR.Infix
pattern InfixR sym precedence optMeta = IR.InfixR sym precedence optMeta

pattern InfixN :: IR.Sym -> IR.OpPrecedence -> Maybe IR.Meta -> IR.Infix
