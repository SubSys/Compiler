...
module SLIR.HelmSyntax.Core.Module.Parser.Root.Header (
    parseModuleHeader
) where
...
-- ~~ Header - Sub Parsers
import qualified SLIR.HelmSyntax.Core.Module.Parser.Header.Base        as Base
import qualified SLIR.HelmSyntax.Core.Module.Parser.Header.ModuleDecl  as ModuleDecl
import qualified SLIR.HelmSyntax.Core.Module.Parser.Header.ImportDecl  as ImportDecl
-- *
