...
module SLIR.HelmSyntax.Core.Module.Parser.Root (
      parseModule
    , parseHeader
) where
...
-- ~~ Header - Sub Parsers
import qualified SLIR.HelmSyntax.Core.Module.Parser.Root.Program as Program
import qualified SLIR.HelmSyntax.Core.Module.Parser.Root.Header  as Header
-- *
...
parseModule path = do
    ...
    return Payload.Module
        ...
        -- | Postpone deps init...
        , Payload.deps = Payload.emptyDependencies
        }
