...
module SLIR.HelmSyntax.Core.Module.InitDeps.Data.MiscAliases (
      ForeignModule
    , ForeignNamespaceOverride
) where
...
type ForeignModule = Payload.Module
type ForeignNamespaceOverride = ID.Namespace
