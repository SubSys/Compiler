...
module SLIR.HelmSyntax.Core.Program.SDD.PostWork.Desugar (
    desugar
) where
...
-- |
-- Finally, the easy part. Misc. Desugaring (if terms, fn args, bin ops)
desugar :: [Decl.Function] -> [Decl.Function]
desugar fns =
