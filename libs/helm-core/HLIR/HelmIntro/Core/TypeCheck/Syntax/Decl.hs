...
module HLIR.HelmIntro.Core.TypeCheck.Syntax.Decl (
      inferDecl
    , inferDeclList
) where
...
import HLIR.HelmIntro.Core.TypeCheck.Sudo.FFI.Helpers           (ifSudoFFI, ignoreDecl)

-- ~ Sub Infers
import qualified HLIR.HelmIntro.Core.TypeCheck.Syntax.Expr as E
-- *
