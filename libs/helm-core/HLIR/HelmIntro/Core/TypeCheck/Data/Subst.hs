...
module HLIR.HelmIntro.Core.TypeCheck.Data.Subst (
      Subst(..)
    , Substitutable(..)
    , compose
    , emptySubst
...
applyTypeSubst (Subst s) ty =
    ...
    where
        ...
        --    maybe in `HLIR.HelmIntro.Core.TypeCheck.Data.System.Constraints`?
        --    Then be simplified, in `HLIR.HelmIntro.Core.TypeCheck.Data.Unification`, or simmular?
