...
module LLIR.LightRoast.Feed.Rust.Base.Values (
    dropValue
) where
...
dropValue :: L.V.LiteralValue -> R.V.LiteralValue
dropValue (L.V.Char val) =
    R.V.Char val

dropValue (L.V.String val) =
    R.V.String val

dropValue (L.V.Int val) =
    R.V.Int val

dropValue (L.V.Float val) =
    R.V.Float val

dropValue (L.V.Bool val) =
    R.V.Bool val
