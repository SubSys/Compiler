...
module HLIR.HelmCore.Core.TypeCheck.Resolve (
      resolveDecls
    , resolveDecl
) where
...
import qualified HLIR.HelmCore.Core.TypeCheck.Data.Unification.Solver     as Solver
...
updateSig (Decl.Function name expr _) scheme =
