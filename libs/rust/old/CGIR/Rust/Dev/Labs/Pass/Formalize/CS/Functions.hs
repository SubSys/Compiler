...
module CGIR.Rust.Dev.Labs.Pass.Formalize.CS.Functions where
        ...
        case result of
            ...
            Right payload ->
                do
                    ...
                    putStrLn $ Text.unpack program
                    putStrLn "\n"
                    putStrLn $ Text.unpack enums
                
                where
                    program = Util.renderFunctions $ IR.getProgram payload
                    enums = Util.renderEnums $ IR.getEnums payload
