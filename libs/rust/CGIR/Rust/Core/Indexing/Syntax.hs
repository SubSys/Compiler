...
module CGIR.Rust.Core.Indexing.Syntax (
    indexer
) where
...
-- ~ Misc. Utils
import CGIR.Rust.Core.Indexing.Auxiliary.Utils (indexList)

-- ~ Root Indexer
import qualified CGIR.Rust.Core.Indexing.Syntax.TopLevel.Functions as Decl
-- *
