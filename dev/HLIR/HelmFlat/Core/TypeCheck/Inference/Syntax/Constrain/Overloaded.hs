...
-- | Helpers for `HLIR.HelmFlat.Core.TypeCheck.Inference.Syntax.Constrain`
--
module HLIR.HelmFlat.Core.TypeCheck.Inference.Syntax.Constrain.Overloaded (
    synthType
) where
...
-- + Local Prelude
import HLIR.HelmFlat.Core.TypeCheck.Inference.Syntax.Base (enter)
