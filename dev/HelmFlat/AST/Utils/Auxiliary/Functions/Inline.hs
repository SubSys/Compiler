...
module HLIR.HelmFlat.AST.Utils.Auxiliary.Functions.Inline (
    inlineDecl
) where
...
inlineDecl :: Decl.Function -> E.Expr
inlineDecl (Decl.Function name args expr sig meta) =
    Binder.voidBinderTypes $ Fold.foldr E.Abs' expr args
