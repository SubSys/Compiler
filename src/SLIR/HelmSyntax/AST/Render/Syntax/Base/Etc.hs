...
module SLIR.HelmSyntax.AST.Render.Syntax.Base.Etc (
    renderBinder
) where
...
renderBinder :: Etc.Binder -> Doc
renderBinder (Etc.Binder ident@ID.OnSym{} (Just ty)) =
    (Util.parens $ ID.renderIdent ident) <+> ":" <+> T.renderType ty

renderBinder (Etc.Binder ident@ID.OnSym{} Nothing) =
    Util.parens $ ID.renderIdent ident

renderBinder (Etc.Binder ident (Just ty)) =
    ID.renderIdent ident <+> ":" <+> T.renderType ty

renderBinder (Etc.Binder ident Nothing) =
