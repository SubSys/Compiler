...
import qualified SLIR.HelmSyntax.Module.System.InitDeps.Imports     as Import
-- *
...
initDeps :: [Import.ForeignModule] -> IO (Either Text I.Module) -> IO (Either Text I.Module)
initDeps deps upstream = do
    result <- upstream
    ...
    case result of
        ...
        Right payload ->
            return
                $ initDeps' deps payload


initDeps' :: [Import.ForeignModule] ->  I.Module -> Either Text I.Module
initDeps' mods payload =
    case Import.processImports mods payload of
