...
module SLIR.HelmSyntax.Module.Core.Parser.Syntax.Header (
    parseModuleHeader
) where
...
import qualified SLIR.HelmSyntax.Module.Core.Parser.Syntax.Header.ModuleDecl as ModuleDecl
import qualified SLIR.HelmSyntax.Module.Core.Parser.Syntax.Header.ImportDecl as ImportDecl
-- *
...
parseModuleHeader :: Pre.FilePath -> Parser I.Header
