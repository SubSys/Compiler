...
module SLIR.HelmSyntax.Module.Core.Parser.Syntax (
    parseModule
  , parseHeader
) where
...
-- + Local
import qualified SLIR.HelmSyntax.Module.Core.Parser.Syntax.Header  as Header
import qualified SLIR.HelmSyntax.Module.Core.Parser.Syntax.Program as Program
-- *
...
-- | # Root Parser
-- *
parseModule :: Pre.FilePath -> Parser I.Module
parseModule path = do
    ...
    return I.Module
        ...
        -- | Postpone deps init...
        , I.deps = I.emptyDependencies
        }


parseHeader :: Pre.FilePath -> Parser I.Header
parseHeader =
