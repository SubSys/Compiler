...
module SLIR.HelmSyntax.Module.Core.TypeCheck.Inference.Syntax.Constrain (
    unify
...
-- ++ Local Helpers
import qualified SLIR.HelmSyntax.Module.Core.TypeCheck.Inference.Syntax.Constrain.Overloaded as OL
-- *
        ...
        Just ss -> do
            error
                ...
                $ Text.unlines
                    ...
                    , Text.pack "I.e. `SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.TermLevel.Expr`:"
