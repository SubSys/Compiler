...
module SLIR.HelmSyntax.Module.Core.TypeCheck.Inference.Data.Env (
    Env(..)
  , Types(..)
  , Overloaded
) where
...
type Env = (Types, Overloaded)


-- | Types Env - Default
-- This tracks the types of expression values within a given inference context.
type Types = Map.Map ID.Ident T.Scheme




-- | Special typing environment for overloaded function signatures
--
type Overloaded = Map.Map ID.Ident [T.Scheme]
