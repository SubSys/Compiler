...
module SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.TopLevel.Functions (
    inferDecl
) where
...
-- ++ Sub Infers
import qualified SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.TermLevel.Expr as E
