...
module SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.TermLevel.Expr (
    inferExpr
) where
...
-- ++ Sub Infers
import qualified SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.Base.Values        as V
import qualified SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.TermLevel.Patterns as P
import qualified SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.Base.Etc           as Etc
import qualified SLIR.HelmSyntax.Module.Core.TypeCheck.Syntax.Base.Metadata      as Meta
-- *
        ...
        Nothing -> do
            ...
            enter
                ...
                tv -- Ensure this is a type variable for later substitution of infered type,
                   -- (for `SLIR.HelmSyntax.Module.Core.TypeCheck.Inference.Engine`)...
