...
module HLIR.HelmFlat.Core.TypeCheck.Inference.Init.Unions (
    genUnionSigs
) where
...
import qualified HLIR.HelmFlat.AST.Utils.Auxiliary.Unions as Union
...
genConstrBinderSig :: Decl.Union -> Decl.Constructor -> (ID.Ident, T.Scheme)
