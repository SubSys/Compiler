...
module HLIR.HelmFlat.Core.Init.Pass.References (
    deFunBaseValues
) where
...
-- NOTE:
-- * Deps on `HLIR.HelmFlat.Core.Init.Pass.SudoFFI.updateSudoFFIBinders`,
--   because it expects all binders to have an associated type.
