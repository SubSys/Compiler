...
module CGIR.Rust.AST.Render.Syntax (
    renderFunctions
  , renderEnums
  , packDoc
) where
...
-- + Local
import qualified CGIR.Rust.AST.Render.Syntax.DeclLevel.Enums     as Decl
import qualified CGIR.Rust.AST.Render.Syntax.DeclLevel.Functions as Decl
-- *
