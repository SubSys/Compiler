...
module CGIR.Rust.Core.Index.Syntax.DeclLevel.Functions (
    traverseDecls
) where
...
import qualified CGIR.Rust.AST.Utils.Generic.SudoFFI as SudoFFI
...
import qualified CGIR.Rust.Core.Index.Syntax.BlockLevel.Stmt as S
import qualified CGIR.Rust.Core.Index.Syntax.Base.Types      as T
import qualified CGIR.Rust.Core.Index.Scope.Generic          as Scope
-- *
