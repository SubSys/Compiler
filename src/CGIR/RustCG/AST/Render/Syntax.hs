...
module CGIR.RustCG.AST.Render.Syntax (
    renderFunctions
  , renderEnums
  , packDoc
) where
...
-- + Local
import qualified CGIR.RustCG.AST.Render.Syntax.DeclLevel.Enums     as Decl
import qualified CGIR.RustCG.AST.Render.Syntax.DeclLevel.Functions as Decl
-- *
