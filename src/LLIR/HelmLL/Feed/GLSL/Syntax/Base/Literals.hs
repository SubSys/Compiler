...
module LLIR.HelmLL.Feed.GLSL.Syntax.Base.Literals (
    dropLiteral
) where
...
dropLiteral :: LL.Lit.LiteralValue -> CG.Lit.LiteralValue
dropLiteral (LL.Lit.Int val)    = CG.Lit.Int val
dropLiteral (LL.Lit.Float val)  = CG.Lit.Float val
dropLiteral (LL.Lit.Bool val)   = CG.Lit.Bool val

dropLiteral (LL.Lit.Char val)   = Error.unsupported "Char"
dropLiteral (LL.Lit.String val) = Error.unsupported "String"
